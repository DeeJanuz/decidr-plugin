...
Current source line: `manifest.json` version `0.1.64`, MCP endpoint `https://app.decidrmcp.com/api/mcp`, OAuth/email-code auth through Ludflow, and release asset `release/decidr.zip`.
